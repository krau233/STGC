...
from utils import match_loss, regularization, row_normalize_tensor,preprocess_cora,preprocess_cora_norm, to_sparse_coo_tensor
    ...
    def train(self, verbose=True):
        ...
        for it in range(args.epochs):
            ...
            optimizer_model = torch.optim.Adam([
                # {"params": compress_model.parameters()},
                # {"params": orgin_model.parameters()},
                {"params": self.stcgcf.parameters()},
            ...
            for b in range(features.shape[0]):
                ...
                for t in range(features.shape[2]):
                    x  = KRR.forward(features[b,:,t,:], H_out[b,:,t,:], labels, labels_syn, to_sparse_coo_tensor(adj.to_dense()), adj_syn_norm)
                    time.append(x)
